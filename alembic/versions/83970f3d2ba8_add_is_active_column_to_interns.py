...
def upgrade() -> None:
    ...
    with op.batch_alter_table('documents', schema=None) as batch_op:
        ...
        batch_op.alter_column('last_update',
               ...
               type_=sa.String(),
               existing_nullable=True,
               existing_server_default=sa.text("(strftime('%Y-%m-%d %H:%M:%S', 'now', 'localtime'))"))
    ...
    with op.batch_alter_table('grades', schema=None) as batch_op:
        ...
        batch_op.alter_column('last_update',
               ...
               existing_nullable=True,
               existing_server_default=sa.text("(datetime('now', 'localtime'))"))
        batch_op.create_unique_constraint('uq_intern_criteria', ['intern_id', 'criteria_id'])
    ...
    with op.batch_alter_table('interns', schema=None) as batch_op:
        ...
        batch_op.alter_column('working_days',
               ...
               type_=sa.String(),
               existing_nullable=True)
        batch_op.alter_column('working_hours',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
        ...
        batch_op.alter_column('last_update',
               ...
               existing_nullable=True,
               existing_server_default=sa.text("(strftime('%Y-%m-%d %H:%M:%S', 'now', 'localtime'))"))
        batch_op.create_unique_constraint(batch_op.f('uq_interns_registration_number'), ['registration_number'])
    ...
    with op.batch_alter_table('meetings', schema=None) as batch_op:
        ...
        batch_op.alter_column('meeting_date',
               ...
               type_=sa.String(),
               existing_nullable=False)
        batch_op.alter_column('is_intern_present',
               existing_type=sa.INTEGER(),
               type_=sa.Boolean(),
               existing_nullable=False)
    ...
    with op.batch_alter_table('venues', schema=None) as batch_op:
        ...
        batch_op.alter_column('address',
               ...
               type_=sa.String(),
               existing_nullable=True)
        batch_op.alter_column('supervisor_name',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
        batch_op.alter_column('supervisor_email',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
        batch_op.alter_column('supervisor_phone',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
        batch_op.alter_column('last_update',
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('interns', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('uq_interns_registration_number'), type_='unique')
        batch_op.alter_column('last_update',
               existing_type=sa.String(),
               type_=sa.TEXT(),
               existing_nullable=True,
